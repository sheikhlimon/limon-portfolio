...
- **No Scroll Snapping or Viewport Locking:** Do not enforce `snap-y`, `snap-start`, or artificial `min-h-[100svh]` on standard content sections. Flow content naturally with consistent section spacing (`space-y-12 sm:space-y-14`).

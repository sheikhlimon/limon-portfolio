    ...
    <div className="min-h-screen">
      <div className="max-w-4xl mx-auto px-5 py-12">
        <div className="space-y-8">
          ...
          <article className="prose prose-gray dark:prose-invert max-w-none prose-headings:font-bold prose-pre:bg-gray-100 dark:prose-pre:bg-gray-800 prose-code:text-pink-600 dark:prose-code:text-pink-400 prose-code:before:content-[''] prose-code:after:content-[''] prose-pre:max-w-full">
            <ReactMarkdown
              ...
              components={{
                ...
                code: ({className, children, ...props}) => {
                  ...
                  return isInline ? (
                    <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-pink-600 dark:text-pink-400 font-mono text-sm break-all" {...props}>
                      {children}
                    </code>
                  ) : (
                    <code className="block text-pink-600 dark:text-pink-400" {...props}>
                      {children}
                    </code>
                  )
                },

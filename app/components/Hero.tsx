    ...
    >
      <div className="flex items-center gap-4 sm:gap-5">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <div className="flex items-center gap-2 flex-wrap text-sm sm:text-base font-display">
            <a
      ...
      <div className="text-gray-700 dark:text-gray-300 space-y-4">
        ...
        <div className="space-y-2.5 font-display text-sm sm:text-base pt-1">
          <div className="flex flex-col sm:flex-row sm:items-start gap-1.5 sm:gap-3">
            <span className="text-gray-400 dark:text-gray-500 sm:w-28 shrink-0 sm:pt-0.5 font-medium">
              maintainer
            </span>
      ...
      <div className="flex flex-wrap items-center gap-x-5 gap-y-2.5 pt-3 border-t border-dashed border-gray-200 dark:border-gray-800/80 text-sm sm:text-base">
        <span className="font-display font-medium text-gray-400 dark:text-gray-500">reach me:</span>
        <button
          onClick={copyEmail}
          className="font-display font-medium text-gray-600 dark:text-gray-400 hover:text-purple-500 dark:hover:text-purple-400 transition-colors cursor-pointer"
        >
          {copied ? "copied!" : "email"}
        </button>
        {SOCIAL_LINKS.map((link) => (
          <a
            ...
            className="font-display font-medium text-gray-600 dark:text-gray-400 hover:text-purple-500 dark:hover:text-purple-400 transition-colors"
          >
        ...
        <Link
          href="/contributions"
          className="font-display font-semibold text-gray-900 dark:text-white hover:text-purple-500 dark:hover:text-purple-400 transition-colors sm:ml-auto"
        >
          contributions →
        </Link>
      </div>
